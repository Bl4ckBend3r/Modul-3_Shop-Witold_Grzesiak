...
export default function RegisterCard({
      ...
      if (onSubmit) {
        ...
        if (!res.ok) {
          ...
          if (err?.field && err?.message) {
            setError(err.field as keyof Form, {
              type: "server",
  ...
  return (
    <div
      className={
        standalone ? "min-h-screen w-full bg-[#2B2F39] flex flex-col" : ""
      }
    >
      <main
        className={
          standalone ? "flex-1 flex items-center justify-center px-4" : ""
        }
      >
        <div className="flex flex-col items-center gap-8 w-[448px]">
          ...
          <form
            ...
            className="w-[448px] bg-[#262626] border border-[#383B42] rounded-[6px] p-6"
            noValidate
          >
            <div id="registerPadd">
              {/* Title + divider */}
              <div className="flex flex-col gap-5 w-[400px]">
                <div className="text-white font-medium text-[24px] leading-[36px] -tracking-[0.01em]">
                  Create Account
                </div>
                  ...
                  render={({ field }) => (
                    <div className="relative w-[400px]">
                      ...
                      {watch("confirm") &&
                        ...
                        !errors.confirm && (
                          <p className="mt-2 text-[12px] leading-[18px] text-[#22C55E]">
                            Passwords match
                          </p>
                        )}
                    </div>
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <div className="w-[400px]">
                      ...
                      <div
                        className="relative w-[400px] h-[54px] rounded-[6px] border px-4"
                        style={{
                          background: "#262626",
                          borderColor: "#616674",
                        }}
                    ...
                    render={({ field }) => (
                      <div className="flex items-start gap-4">
                        ...
                        <p className="text-[14px] leading-[24px] text-[#E7E7E7]">
                          ...
                          .
                          {errors.agree && (
                            <span className="ml-2 text-[#E05816]">
...
function PasswordHints({
  ...
  return (
    <div className="mt-2">
          ...
          <li key={r.label} className="flex items-center gap-2">
            <span
              className={`inline-block w-2.5 h-2.5 rounded-full ${
                r.ok ? "bg-[#22C55E]" : "bg-[#616674]"
              }`}
            />
            <span
              className={`text-[12px] leading-[18px] ${
                r.ok ? "text-neutral-300" : "text-neutral-500"
              }`}
            >
              {r.label}
            </span>
      ...
      {capsOn && (
        <p className="mt-2 text-[12px] leading-[18px] text-[#E05816]">
          Caps Lock is on
        </p>
      )}
    </div>
